...
Do not create new .md files (examples: CHANGES.md, FLOW_DIAGRAM.md, QUICK_REFERENCE.md, SETUP_FLOW.md) and other general documentation/summary files. Instead when a summary is needed, update .github/copilot-instructions.md so it contains only the most critical of the information. Do NOT include any code in copilot-instructions.md unless absolutely necessary.
...
Edit package.json version number: "version": "X.Y.Z" where X = MAJOR, Y = MINOR, Z = PATCH